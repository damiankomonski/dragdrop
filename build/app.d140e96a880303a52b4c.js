...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('App', ['ui.router', 'hmTouchEvents', 'start', 'game', 'result']).config(function ($stateProvider, $urlRouterProvider, $locationProvider) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameModule = angular.module('game', [_angularResource2.default]).component('gameComponent', _game2.default).config(function ($stateProvider) {
...
/***/ function(module, exports) {
	...
	var GameController = function () {
	    function GameController($state, $stateParams, $interval, $timeout) {
	    ...
	    _createClass(GameController, [{
	        key: 'onHammer',
	        value: function onHammer($event, object) {
	            object.positionLeft = object.oldLeftPosition + $event.deltaX;
	            object.positionTop = object.oldTopPosition + $event.deltaY;

	            if (object.positionLeft < 0) {
	                object.positionLeft = 0;
	            }
	            if (object.positionLeft > window.innerWidth - object.width) {
	                object.positionLeft = window.innerWidth - object.width;
	            }
	            if (object.positionTop < 52) {
	                object.positionTop = 52;
	            }
	            if (object.positionTop > window.innerHeight - object.height) {
	                object.positionTop = window.innerHeight - object.height;
	            }
	        ...
	        key: 'dropHammer',
	        value: function dropHammer($event, object) {
	            object.oldLeftPosition = object.positionLeft;
	            object.oldTopPosition = object.positionTop;
	        }
	    }, {
	        key: 'checkColision',
	        value: function checkColision(box1, box2) {
	            if (box1.positionLeft < box2.positionLeft + box2.width && box1.positionLeft + box1.width > box2.positionLeft && box1.positionTop < box2.positionTop + box2.height && box1.positionTop + box1.height > box2.positionTop) {
	                if (!box1.matching) {
	                    this.matchingCount++;
	                }
	                box1.matching = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _start3 = __webpack_require__(11);
	...
	var StartModule = angular.module('start', [_angularResource2.default]).component('startComponent', _start2.default).factory('loadFileFactory', _start4.default).config(function ($stateProvider) {
...
/***/ function(module, exports) {
	...
	var StartController = function () {
	    function StartController($state, $resource, loadFileFactory) {
	    ...
	    _createClass(StartController, [{
	        ...
	        value: function getFileData() {
	            ...
	            this.loadFileFactory.query().$promise.then(function (data) {
	                _this.JSONData = data;
	                _this.loadFileJSONRandomData();
	                _this.id = _this.JSONData.length;
	            });
	        }
	    }, {
	        key: "loadFileJSONRandomData",
	        value: function loadFileJSONRandomData() {
...
/***/ function(module, exports) {
	...
	var loadFileFactory = function loadFileFactory($resource) {
	    return $resource('./src/app/data.json');
	};

	exports.default = loadFileFactory;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultModule = angular.module('result', [_angularResource2.default]).component('resultComponent', _result2.default).config(function ($stateProvider) {
...
/***/ function(module, exports) {
	...
	var ResultController = function ResultController($state, $stateParams) {
	    _classCallCheck(this, ResultController);
